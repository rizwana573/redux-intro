...
var _myReduxJs = require("./my-redux.js");
const initialState = {
    name: "Riz",
    post: 0,
    age: 30
...
const myStore = (0, _myReduxJs.myCreateStore)(reducer);
console.log(store);
console.log(myStore);
myStore.subscribe(()=>{
...
},{"redux":"7RvxM","./my-redux.js":"1T9yH"}],"7RvxM":[function(require,module,exports,__globalThis) {
